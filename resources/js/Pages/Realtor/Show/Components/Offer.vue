<template>
  <Box>
    <template #header>
      Offer #{{ offer.id }}
      <span v-if="offer.accepted_at" class="dark:bg-green-900 dark:text-green-200 text-xs bg-green-200 text-green-900 p-2 rounded-md uppercase ml-1">accepted</span>
    </template>
